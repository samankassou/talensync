...
<header class="header">
    <nav class="navbar container">
        ...
        <div class="order-0">
            <a href="index.html">
                <img src="theme/images/logo.svg" height="30" width="147" alt="logo" />
            </a>
        </div>
        <!-- navbar toggler -->
    ...
    <section class="section banner relative">
        <div class="container">
            <div class="row items-center">
                ...
                <div class="lg:col-6">
                    <img class="w-full object-contain" src="theme/images/banner-img.png" width="603"
                        height="396" alt="" />
                </div>
            </div>
        </div>
        <img class="banner-shape absolute -top-28 right-0 -z-[1] w-full max-w-[30%]"
            src="theme/images/banner-shape.svg" alt="" />
    </section>
    <!-- ./end Banner -->

    <!-- Key features -->
    <section class="section key-feature relative">
        <img class="absolute left-0 top-0 -z-[1] -translate-y-1/2" src="theme/images/icons/feature-shape.svg"
            alt="" />
        <div class="container">
            ...
            <div class="key-feature-grid mt-10 grid grid-cols-2 gap-7 md:grid-cols-3 xl:grid-cols-4">
                <div class="flex flex-col justify-between rounded-lg bg-white p-5 shadow-lg">
                    ...
                    <span class="icon mt-4">
                        <img class="objec-contain" src="theme/images/icons/feature-icon-1.svg" alt="" />
                    </span>
                </div>
                <div class="flex flex-col justify-between rounded-lg bg-white p-5 shadow-lg">
                    <div>
                    ...
                    <span class="icon mt-4">
                        <img class="objec-contain" src="theme/images/icons/feature-icon-2.svg" alt="" />
                    </span>
                </div>
                <div class="flex flex-col justify-between rounded-lg bg-white p-5 shadow-lg">
                    <div>
                    ...
                    <span class="icon mt-4">
                        <img class="objec-contain" src="theme/images/icons/feature-icon-3.svg" alt="" />
                    </span>
                </div>
                <div class="flex flex-col justify-between rounded-lg bg-white p-5 shadow-lg">
                    <div>
                    ...
                    <span class="icon mt-4">
                        <img class="objec-contain" src="theme/images/icons/feature-icon-4.svg" alt="" />
                    </span>
                </div>
                <div class="flex flex-col justify-between rounded-lg bg-white p-5 shadow-lg">
                    <div>
                    ...
                    <span class="icon mt-4">
                        <img class="objec-contain" src="theme/images/icons/feature-icon-5.svg" alt="" />
                    </span>
                </div>
                <div class="flex flex-col justify-between rounded-lg bg-white p-5 shadow-lg">
                    <div>
                    ...
                    <span class="icon mt-4">
                        <img class="objec-contain" src="theme/images/icons/feature-icon-6.svg" alt="" />
                    </span>
                </div>
                <div class="flex flex-col justify-between rounded-lg bg-white p-5 shadow-lg">
                    <div>
                    ...
                    <span class="icon mt-4">
                        <img class="objec-contain" src="theme/images/icons/feature-icon-7.svg" alt="" />
                    </span>
                </div>
                <div class="flex flex-col justify-between rounded-lg bg-white p-5 shadow-lg">
                    <div>
                    ...
                    <span class="icon mt-4">
                        <img class="objec-contain" src="theme/images/icons/feature-icon-8.svg" alt="" />
                    </span>
                </div>
                <div class="flex flex-col justify-between rounded-lg bg-white p-5 shadow-lg">
                    <div>
                    ...
                    <span class="icon mt-4">
                        <img class="objec-contain" src="theme/images/icons/feature-icon-9.svg" alt="" />
                    </span>
                </div>
                <div class="flex flex-col justify-between rounded-lg bg-white p-5 shadow-lg">
                    <div>
                    ...
                    <span class="icon mt-4">
                        <img class="objec-contain" src="theme/images/icons/feature-icon-10.svg" alt="" />
                    </span>
                </div>
            </div>
        </div>
        ...
        <div class="container">
                ...
                <div class="lg:col-7 lg:order-2">
                    <div class="tab-content" data-tab-content>
                        <div class="tab-content-panel active" data-tab-panel="0">
                            <img class="w-full object-contain" src="theme/images/sells-by-country.png" />
                        </div>
                        <div class="tab-content-panel" data-tab-panel="1">
                            <img class="w-full object-contain" src="theme/images/collaboration.png" />
                        </div>
                    ...
                    <div class="text-container">
                        ...
                        <ul class="tab-nav -ml-4 mt-8 border-b-0" data-tab-nav>
                            <li class="tab-nav-item active" data-tab="0">
                                <img class="mr-3" src="theme/images/icons/drop.svg" alt="" />
                                Habit building essential choose habit
                            </li>
                            <li class="tab-nav-item" data-tab="1">
                                <img class="mr-3" src="theme/images/icons/brain.svg" alt="" />
                                Get an overview of Habit Calendars.
                            </li>
                            <li class="tab-nav-item" data-tab="2">
                                <img class="mr-3" src="theme/images/icons/timer.svg" alt="" />
            ...
            <div class="row gx-5 mt-12 items-center lg:mt-0">
                <div class="lg:col-7">
                    <div class="relative">
                        <img class="w-full object-contain" src="theme/images/collaboration.png" />
                        <img class="absolute bottom-6 left-1/2 -z-[1] -translate-x-1/2" src="theme/images/shape.svg"
                            alt="" />
                    </div>
                </div>
                <div class="mt-6 lg:col-5 lg:mt-0">
                    <div class="text-container">
                        ...
                        <ul class="mt-6 text-dark lg:-ml-4">
                            <li class="mb-2 flex items-center rounded px-4">
                                <img class="mr-3" src="theme/images/icons/checkmark-circle.svg" alt="" />
                ...
                <div class="lg:col-7 lg:order-2">
                    <div class="video pb-5 pr-9">
                        <div class="video-thumbnail overflow-hidden rounded-2xl">
                            <img class="w-full object-contain" src="theme/images/intro-thumbnail.png"
                                alt="" />
                            <button class="video-play-btn">
                                <img src="theme/images/icons/play-icon.svg" alt="" />
                            </button>
                        </div>
                        ...
                        <img class="intro-shape absolute bottom-0 right-0 -z-[1]" src="theme/images/shape.svg"
                            alt="" />
                    </div>
                </div>
                <div class="mt-6 lg:col-5 lg:order-1 lg:mt-0">
                    ...
                    <div class="swiper reviews-carousel">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <div class="review">
                                    <div class="review-author-avatar bg-gradient">
                                        <img src="theme/images/users/user-5.png" alt="" />
                                    </div>
                                    ...
                                    <div class="review-rating mt-6 flex items-center justify-center space-x-2.5">
                                        <img src="theme/images/icons/star.svg" alt="" />
                                        <img src="theme/images/icons/star.svg" alt="" />
                                        <img src="theme/images/icons/star.svg" alt="" />
                                        <img src="theme/images/icons/star.svg" alt="" />
                                        <img src="theme/images/icons/star-white.svg" alt="" />
                                    </div>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="review">
                                    <div class="review-author-avatar bg-gradient">
                                        <img src="theme/images/users/user-2.png" alt="" />
                                    </div>
                            ...
                            <div class="swiper-slide">
                                <div class="review">
                                    <div class="review-author-avatar bg-gradient">
                                        <img src="theme/images/users/user-6.png" alt="" />
                                    </div>
    ...
    <footer class="footer bg-theme-light/50">
        <div class="container">
            <div class="row gx-5 pb-10 pt-[52px]">
                ...
                <div class="col-12 mt-12 md:col-6 lg:col-3">
                    <h6>Socials</h6>
                    <p>samankassoufoulla@gmail.com</p>
