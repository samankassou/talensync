        ...
        <section class="section banner relative">
            <div class="container">
                <div class="row items-center">
                    ...
                    <div class="lg:col-6">
                        <img class="w-full object-contain" src="theme/images/banner-img.png" width="603" height="396"
                            alt="" />
                    </div>
                </div>
            </div>
            <img class="banner-shape absolute -top-28 right-0 -z-[1] w-full max-w-[30%]" src="theme/images/banner-shape.svg"
                alt="" />
        </section>
        {{--  ./end Banner --}}
