...
@section('content')
    ...
    <body><!-- floating assets -->
        <img class="floating-bubble-1 absolute right-0 top-0 -z-[1]" src="theme/images/floating-bubble-1.svg" alt="" />
        <img class="floating-bubble-2 absolute left-0 top-[387px] -z-[1]" src="theme/images/floating-bubble-2.svg"
            alt="" />
        <img class="floating-bubble-3 absolute right-0 top-[605px] -z-[1]" src="theme/images/floating-bubble-3.svg"
            alt="" />
        <!-- ./end floating assets -->
        ...
        <section class="page-hero py-16">
            <div class="container">
                ...
                <div class="mt-14 flex justify-center">
                    <div class="relative">
                        <img src="theme/images/career/career-hero-img-1.png" alt="" />
                        <img class="absolute -left-[8%] bottom-[12%] z-[-1] h-20 w-20 -rotate-90 lg:-left-8 lg:bottom-4 lg:h-[150px] lg:w-[150px]"
                            src="theme/images/shape.svg" alt="" />
                    </div>
                    <div class="relative -ml-[10%] mt-[10%] lg:-ml-[6%] lg:mt-[6%]">
                        <img src="theme/images/career/career-hero-img-2.png" alt="" />
                        <img class="absolute -right-4 -bottom-4 z-[-1] h-16 w-16 -rotate-90" src="theme/images/shape.svg"
                            alt="" />
                    </div>
                </div>
            </div>
            ...
            <div class="container">
                ...
                <div class="row mt-14 text-center">
                    <div class="mb-10 sm:col-6 lg:col-4">
                        <img class="mx-auto" src="theme/images/career/icon-1.png" width="100" h="90" alt="" />
                    ...
                    <div class="mb-10 sm:col-6 lg:col-4">
                        <img class="mx-auto" src="theme/images/career/icon-2.png" width="100" h="90" alt="" />
                    ...
                    <div class="mb-10 sm:col-6 lg:col-4">
                        <img class="mx-auto" src="theme/images/career/icon-3.png" width="100" h="90" alt="" />
                    ...
                    <div class="mb-10 sm:col-6 lg:col-4">
                        <img class="mx-auto" src="theme/images/career/icon-4.png" width="100" h="90" alt="" />
                    ...
                    <div class="mb-10 sm:col-6 lg:col-4">
                        <img class="mx-auto" src="theme/images/career/icon-5.png" width="100" h="90" alt="" />
                    ...
                    <div class="mb-10 sm:col-6 lg:col-4">
                        <img class="mx-auto" src="theme/images/career/icon-6.png" width="100" h="90" alt="" />
        ...
        <section class="section">
            <div class="container">
                ...
                <div class="row mt-12">
                    @foreach ($publishedJobPosts as $jobPost)
                        <div class="mb-8 md:col-6">
                            <div class="rounded-xl bg-white p-5 shadow-lg lg:p-10">
                                <h3 class="h4">{{ $jobPost->title }}</h3>
                                <p class="mt-6 line-clamp-3">
                                    {{ $jobPost->description }}
                                </p>
                                <ul class="mt-6 flex flex-wrap items-center text-dark">
                                    <li class="my-1 mr-8 inline-flex items-center">
                                        ...
                                        {{ $jobPost->contract_type }}
                                    </li>
                                    <li class="my-1 mr-8 inline-flex items-center">
                                        <svg class="mr-1" width="16" height="20" viewBox="0 0 23 33"
                                            fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path
                                    ...
                                    <li class="my-1 mr-8">
                                        <a class="inline-flex items-center font-semibold text-primary" href="#">Read
                                            More
                                            <img class="ml-1.5" src="theme/images/icons/arrow-right.svg"
                                                alt="" />
                                        </a>
                                    </li>
                                </ul>
