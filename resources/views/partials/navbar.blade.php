    <header class="header">
        <nav class="navbar container">
            ...
            <div class="order-0">
                <a href="/">
                    <img src="{{ asset('theme/images/logo.svg') }}" height="30" width="147" alt="logo" />
                </a>
            </div>
            {{--  navbar toggler --}}
            ...
            <ul id="nav-menu"
                ...
                <li class="nav-item">
                    <a href="/" @class(['nav-link', 'active' => request()->routeIs('home')])>{{ __('Home') }}</a>
                </li>
                <li class="nav-item">
                    <a href="{{ route('job_posts.index') }}" @class(['nav-link', 'active' => request()->routeIs('job_posts.*')])>Job posts</a>
                </li>
                <li class="nav-item">
